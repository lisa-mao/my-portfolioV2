...
export default function Skills() {
    return (
        <main>
            <div className="pl-4 pr-4 m-3 flex md:flex-row flex-col md:items-center items-start gap-4 justify-between ">

                <h1 className="jersey-10-regular">Zo breng ik ideeën tot leven</h1>
                <button className="border-2 border-black flex justify-center items-center  border-solid rounded-xl bg-white">
                    <Link href="/tools"
